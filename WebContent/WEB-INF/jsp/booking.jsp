	...
	<div class="book_list_block">
		...
		<div class="book_list">
			<c:forEach items="${page.rows}" var="row">
				<!-- 订单单元 -->
				<div class="book_unit">
				<div class="book_unit_inner" onmouseover()="bigger()">
					<!-- 文本信息 -->
					<div class="book_info">
						<p class="bk_time">${row.btime}</p>
						<p class="bk_money">租金--${row.bmoney}元</p>
						<p class="bk_month">租期--${row.bmonth}个月</p>
						<p class="bk_master">房东--${row.bmasterid.username}</p>		
					</div>
					<!-- 订单详情 -->
					<a class="book_detail" href="<%=request.getContextPath()%>/booking/detail.action?bno=${row.bno}">详情>></a>
				</div>
				</div>
			</c:forEach>
		<!-- book_list结束 -->
